...
public class TestSuiteFirefox {
    ...
    public By localizadorSearch = By.xpath("//input[@class=\"search_query form-control ac_input\"]");
    ...
    public By localizadoraAutoComplete = By.xpath("//div[@class=\"ac_results\"]");
    ...
    @Test public void ACT05()  { //Abrir la pagina
        driver.get("http://automationpractice.com/index.php");
        WebElement search = driver.findElement(localizadorSearch);
        search.sendKeys("blo");
        WebDriverWait delay = new WebDriverWait(driver, Duration.ofSeconds(5));
